                    ...
                    <form method="POST" action="{{ route('devices.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <select id="office_id" name="office_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                            ...
                            <div>
                                ...
                                <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" placeholder="Ej: Router Principal Piso 1" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="ip_address" class="block mt-1 w-full" type="text" name="ip_address" :value="old('ip_address')" placeholder="192.168.1.1" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="snmp_port" class="block mt-1 w-full" type="number" name="snmp_port" :value="old('snmp_port', 161)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="snmp_community" class="block mt-1 w-full" type="text" name="snmp_community" :value="old('snmp_community', 'public')" required />
                            ...
                            <div class="flex items-center mt-4">
                                ...
                                <label for="is_active" class="ml-2 block text-sm text-gray-900">{{ __('Activar Monitoreo') }}</label>
                            </div>
                        </div>

                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('devices.index') }}" class="text-gray-600 hover:text-gray-900 mr-4">Cancelar</a>
