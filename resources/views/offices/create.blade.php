                    ...
                    <form method="POST" action="{{ route('offices.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="text" name="name" :value="old('name')" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="branch_code" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="text" name="branch_code" :value="old('branch_code')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="state" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="text" name="state" :value="old('state')" placeholder="Ej: Distrito Capital" />
                            ...
                            <div>
                                ...
                                <x-text-input id="city" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="text" name="city" :value="old('city')" placeholder="Ej: Caracas" />
