                    ...
                    <form method="POST" action="{{ route('devices.update', $device) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <select id="office_id" name="office_id" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                    @foreach($offices as $office)
                                        <option value="{{ $office->id }}" {{ old('office_id', $device->office_id) == $office->id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <x-text-input id="name" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="text" name="name" :value="old('name', $device->name)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="ip_address" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="text" name="ip_address" :value="old('ip_address', $device->ip_address)" required />
                            ...
                            <div>
                                ...
                                <select id="type" name="type" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                    ...
                                    <option value="server" {{ old('type', $device->type) == 'server' ? 'selected' : '' }}>Servidor</option>
                            ...
                            <div>
                                ...
                                <x-text-input id="snmp_port" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="number" name="snmp_port" :value="old('snmp_port', $device->snmp_port)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="snmp_community" class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:ring-indigo-500 dark:focus:ring-indigo-600" type="text" name="snmp_community" :value="old('snmp_community', $device->snmp_community)" required />
                                <x-input-error :messages="$errors->get('snmp_community')" class="mt-2" />
                            </div>

                            <!-- Active Status -->
                            <div class="flex items-center mt-4">
                                <input id="is_active" type="checkbox" name="is_active" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('is_active', $device->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <x-primary-button>{{ __('Actualizar Dispositivo') }}</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
